...
// export default function CommanModal(
//   modalTitle,
//   mainContent,
//   showButtons,
//   buttonComponent,
...
//         <div className="fixed inset-0 overflow-hidden">
//           <div className="absolute inset-0 overflow-hidden">
//             <div className="fixed inset-y-0 right-0 flex-w-full pl-10">
//               <TransitionChild
//                 as={Fragment}
//                 enter="ease-in-out duration-900"
//                 enterFrom="opacity-0"
...
//                   <div className="flex h-full flex-col overflow-y-scroll bg-black shadow-x1">
//                     <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
//                       {showModalTitle ? (
